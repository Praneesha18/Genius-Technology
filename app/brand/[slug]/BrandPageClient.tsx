...
export default function BrandPageClient({ params }: BrandPageProps) {
  ...
  const [filters, setFilters] = useState({
    category: "",
    brand: brandName, // Pre-set brand filter
    minPrice: 0,
    maxPrice: 100000,
    minRating: 0,
    inStock: false,
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const q = query(productsCollection, where("brand", "==", brandName), orderBy("name"))
  ...
  const breadcrumbs = [
    ...
    { name: brandName, href: `/brand/${brandSlug}` },
  ]
          ...
          <div className="hidden lg:block lg:w-1/4">
            <ProductFilters
              ...
              onClearAll={() => {
                setFilters({
                  category: "",
                  brand: brandName, // Keep brand filter
                  minPrice: 0,
                  maxPrice: 100000,
                  minRating: 0,
                  inStock: false,
          ...
          <div className="flex-1">
            ...
            {filteredAndSortedProducts.length === 0 ? (
              <Card className="p-6 text-center text-gray-500">
                No products found for this brand matching your criteria. Try adjusting your filters or search query.
              </Card>
            ) : (
              <div
                className={
